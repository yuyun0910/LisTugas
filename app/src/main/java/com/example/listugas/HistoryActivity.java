...
import com.example.listugas.ui.home.HomeFragment;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public static class NewViewHolder2 extends RecyclerView.ViewHolder {
                ...
                DBreference.child(key).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(HistoryActivity.this, "Changed Successfully.", Toast.LENGTH_SHORT).show();
                        } else {
                            String error = task.getException().toString();
                            Toast.makeText(HistoryActivity.this, "Failed: " + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
